...
public class AdminController {
    ...
    private static AdminFlipfitImplService adminService = new AdminFlipfitImplService();
    private static GymOwnerFlipfitImplService gymOwnerService = new GymOwnerFlipfitImplService();
