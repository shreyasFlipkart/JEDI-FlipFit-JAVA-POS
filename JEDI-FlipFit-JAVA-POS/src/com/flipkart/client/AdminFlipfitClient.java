...
import com.flipkart.business.GymOwnerFlipfitFlipfitService;
...
public class AdminFlipfitClient {
    ...
    private static GymOwnerFlipfitServiceInterface gymOwnerService = new GymOwnerFlipfitFlipfitService();
